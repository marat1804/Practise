...
const char* menu[] = { "0. Exit", "1. Add contact on circuit", "2. Add connection", "3. Route distance","4. Delete contact", "5. Print", "6. Select a specific type ", "7. Tracing"};
